...
class Skin_Hero1 extends Skin_Base {

    protected function _register_controls_actions() {
        parent::_register_controls_actions();
        add_action( 'elementor/element/blfe-post-grid/hero1_section_excerpt/before_section_end', [ $this, 'register_update_excerpt_controls' ] );
    }
