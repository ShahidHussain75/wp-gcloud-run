...
class Skin_Hero3 extends Skin_Base {

    protected function _register_controls_actions() {
        parent::_register_controls_actions();
        add_action( 'elementor/element/blfe-post-grid/hero3_section_excerpt/before_section_end', [ $this, 'register_update_excerpt_controls' ] );
        ...
        add_action( 'elementor/element/blfe-post-grid/hero3_section_design_layout/before_section_end', [ $this, 'register_update_section_design_layout_controls' ] );
        add_action('elementor/element/blfe-post-grid/hero3_section_carousel/before_section_end', [$this, 'register_update_section_carousel_controls']);
    }
